...
class ForexTrainer:
    ...
    def build_sequential_model(self, input_shape):
        ...
        model.compile(
            ...
            loss="huber",   # more robust than MSE for financial noise
            metrics=["mae"]
        )
        return model

    def train_model_for_pair(self, symbol="EUR/USD", timeframe="1day", epochs=50, batch_size=32):
        """
